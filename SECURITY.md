...
## Supported Versions
Only the latest version of ThreatDock is currently supported for security updates.
...
## Security Research
As this is a security-focused tool, I encourage responsible research. Please ensure that testing does not involve unauthorized access to third-party APIs (OTX, ThreatFox, etc.) beyond your own authorized keys.
